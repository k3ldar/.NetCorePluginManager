...
{
	[Table(Constants.DomainSessions, Constants.TableNameSessionStatsWeekly, CompressionType.Brotli, CachingStrategy.SlidingMemory, WriteStrategy.Lazy, SlidingMemoryTimeoutMilliseconds = 300)]
