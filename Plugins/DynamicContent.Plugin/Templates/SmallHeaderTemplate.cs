 ...
 *  
 *  File: SmallHeaderTemplate.cs
 *
 *  Purpose:  H5 text template for dynamic pages
 *
 *  Date        Name                Reason
...
{
    public class SmallHeaderTemplate : DynamicContentTemplate
    {
        #region Constructors

        public SmallHeaderTemplate()
        {
        ...
        public override string AssemblyQualifiedName => typeof(SmallHeaderTemplate).AssemblyQualifiedName;
        ...
        public override DynamicContentTemplate Clone(string uniqueId)
        {
            ...
            return new SmallHeaderTemplate()
            {
                UniqueId = uniqueId
            };
        }
        ...
        private string GenerateContent(bool isEditing)
        {
            ...
            Result.AppendFormat("<h5{0}>", RetrieveCssClassAndStyle());
            Result.Append(Data);
            Result.Append("</h5>");
