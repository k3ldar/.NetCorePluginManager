...
namespace Middleware
{
    public interface IProductProvider
    {
        ...
        IEnumerable<ProductGroup> ProductGroupsGet();

        ProductGroup ProductGroupGet(int id);
        ...
        List<Product> GetProducts(ProductGroup productGroup, in int page, in int pageSize);
