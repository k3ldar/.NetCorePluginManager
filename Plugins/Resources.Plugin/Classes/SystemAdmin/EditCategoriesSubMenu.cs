...
{
	public class EditCategoriesSubMenu : SystemAdminSubMenu
	{
		public override string Action()
		{
			return nameof(Controllers.ResourcesController.ManageCategories);
		}
		...
		{
			return Languages.LanguageStrings.ManageCategories;
		}
