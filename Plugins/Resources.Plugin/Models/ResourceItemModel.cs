...
namespace Resources.Plugin.Models
{
	...
	public sealed class ResourceItemModel
	{
		...
		public ResourceItemModel(long id, long categoryId, ResourceType resourceType, long userId, string userName, string name, string description, string value, int likes, int dislikes, bool approved)
		{
			Id = id;
