...
namespace AspNetCore.PluginManager.Tests.Plugins.DynamicContentTests
{
    ...
    public class DefaultDynamicContentProviderTests : GenericBaseClass
    {
        ...
        private const string HtmlTemplateAssemblyQualifiedName = "DynamicContent.Plugin.Templates.HtmlTextTemplate, DynamicContent.Plugin, Version=4.2.0.0, Culture=neutral, PublicKeyToken=null";
