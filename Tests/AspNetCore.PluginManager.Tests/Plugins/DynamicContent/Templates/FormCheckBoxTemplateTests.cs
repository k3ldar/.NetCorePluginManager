...
namespace AspNetCore.PluginManager.Tests.Plugins.DynamicContentTests
{
    ...
    public class FormCheckBoxTemplateTests : GenericBaseClass
    {
        ...
        private const string BlankDataDefaultValues12Columns = "<div class=\"col-sm-12\"><div class=\"form-group\"><label for=\"test\">Enter test data</label><input type=\"checkbox\" class=\"form-check-input\" id=\"test\"></div></div>";
        private const string BlankDataDefaultValues12ColumnsNoLabel = "<div class=\"col-sm-12\"><div class=\"form-group\"><input type=\"checkbox\" class=\"form-check-input\" id=\"test\"></div></div>";
        private const string BlankDataDefaultValues12ColumnsEditor = "<div class=\"col-sm-12\"><div class=\"form-group\" style=\"margin: 0 0 0 10px;min-height:32px;\"><input type=\"checkbox\" class=\"form-check-input\" id=\"test\" disabled><label for=\"test\" class=\"form-check-label\">Enter test data</label></div></div>";
        private const string BlankDataDefaultValues12ColumnsEditorNoLabel = "<div class=\"col-sm-12\"><div class=\"form-group\" style=\"margin: 0 0 0 10px;min-height:32px;\"><input type=\"checkbox\" class=\"form-check-input\" id=\"test\" disabled></div></div>";
        private const string BlankDataDefaultValues10Columns = "<div class=\"col-sm-10\"><div class=\"form-group\"><input type=\"checkbox\" class=\"form-check-input\" id=\"test\"><label for=\"test\" class=\"form-check-label\">Enter test data</label></div></div>";
        private const string BlankDataDefaultValues10ColumnsNoLabel = "<div class=\"col-sm-10\"><div class=\"form-group\"><input type=\"checkbox\" class=\"form-check-input\" id=\"test\"></div></div>";
        private const string BlankDataDefaultValues8Columns = "<div class=\"col-sm-8\"><div class=\"form-group\"><input type=\"checkbox\" class=\"form-check-input\" id=\"test\"><label for=\"test\" class=\"form-check-label\">Enter test data</label></div></div>";
        private const string BlankDataDefaultValues8ColumnsNoLabel = "<div class=\"col-sm-8\"><div class=\"form-group\"><input type=\"checkbox\" class=\"form-check-input\" id=\"test\"></div></div>";
        private const string FormWithLabelGreenBorderLineBreak = "<div class=\"col-sm-10\"><div class=\"form-group css-class\" style=\"border: 1px solid green;\"><label for=\"textbox1\" class=\"form-check-label\">Fill in the data</label><br /><input type=\"checkbox\" class=\"form-check-input\" id=\"textbox1\"></div></div>";
        private const string FormWithLabelGreenBorder = "<div class=\"col-sm-10\"><div class=\"form-group css-class\" style=\"border: 1px solid green;\"><input type=\"checkbox\" class=\"form-check-input\" id=\"textbox1\"><label for=\"textbox1\" class=\"form-check-label\">Fill in the data</label></div></div>";
        private const string FormWithLabelGreenBorderControlStyles = "<div class=\"col-sm-10\"><div class=\"form-group css-class\" style=\"border: 1px solid green;\"><input type=\"checkbox\" class=\"form-check-input\" id=\"textbox1\" style=\"width: 70%;\"><label for=\"textbox1\" class=\"form-check-label\" style=\"border: 1px solid green;\">Fill in the data</label></div></div>";
        private const string DefaultData538Pixels = "<div style=\"width:538px !important;display:block;\"><div class=\"form-group\"><input type=\"checkbox\" class=\"form-check-input\" id=\"test\"><label for=\"test\" class=\"form-check-label\">Enter test data</label></div></div>";
        private const string DefaultData538PixelsNoLabel = "<div style=\"width:538px !important;display:block;\"><div class=\"form-group\"><input type=\"checkbox\" class=\"form-check-input\" id=\"test\"></div></div>";
        private const string DefaultData40Percent = "<div style=\"width:40% !important;display:block;\"><div class=\"form-group\"><input type=\"checkbox\" class=\"form-check-input\" id=\"test\"><label for=\"test\" class=\"form-check-label\">Enter test data</label></div></div>";
        private const string DefaultData40PercentNoLabel = "<div style=\"width:40% !important;display:block;\"><div class=\"form-group\"><input type=\"checkbox\" class=\"form-check-input\" id=\"test\"></div></div>";
