...
namespace AspNetCore.PluginManager.Tests.Plugins.DynamicContentTests
{
    ...
    public class FormListBoxTemplateTests : GenericBaseClass
    {
        ...
        private const string BlankDataDefaultValues12ColumnsEditor = "<div class=\"col-sm-12\"><div class=\"form-group\" style=\"margin: 0 0 0 10px;min-height:32px;\"><select name=\"test\" id=\"test\" disabled><option value=\"Option-X\" selected>Option X</option><option value=\"Option-Y\">Option Y</option><option value=\"Option-Z\">Option Z</option></select></div></div>";
        private const string BlankDataDefaultValues10Columns = "<div class=\"col-sm-10\"><div class=\"form-group\"><label for=\"test\">Select One of these!</label><select name=\"test\" id=\"test\"><option value=\"Option-1\" selected>Option 1</option><option value=\"Option-2\">Option 2</option><option value=\"Option-3\">Option 3</option></select></div></div>";
        private const string BlankDataDefaultValues8Columns = "<div class=\"col-sm-8\"><div class=\"form-group\"><label for=\"test\">Select an option:</label><select name=\"test\" id=\"test\"><option value=\"Select-this\" selected>Select this</option><option value=\"or-this\">or this</option></select></div></div>";
        private const string BlankDataDefaultValues8ColumnsNoLabel = "<div class=\"col-sm-8\"><div class=\"form-group\"><select name=\"test\" id=\"test\"><option value=\"Option-A\" selected>Option A</option><option value=\"Option-B\">Option B</option></select></div></div>";
        private const string FormWithLabelGreenBorderLineBreak = "<div class=\"col-sm-10\"><div class=\"form-group css-class\" style=\"border: 1px solid green;\"><label for=\"textbox1\">Select an option:</label><br /><select name=\"textbox1\" id=\"textbox1\"><option value=\"Option-A\" selected>Option A</option><option value=\"Option-B\">Option B</option></select></div></div>";
        private const string FormWithLabelGreenBorder = "<div class=\"col-sm-10\"><div class=\"form-group css-class\" style=\"border: 1px solid green;\"><label for=\"textbox1\">Select an option:</label><select name=\"textbox1\" id=\"textbox1\"><option value=\"Option-1\" selected>Option 1</option><option value=\"Option-2\">Option 2</option></select></div></div>";
        private const string FormWithLabelGreenBorderControlStyles = "<div class=\"col-sm-10\"><div class=\"form-group css-class\" style=\"border: 1px solid green;\"><label for=\"textbox1\" style=\"border: 1px solid green;\">Select the option</label><select name=\"textbox1\" id=\"textbox1\" style=\"width: 70%;\"><option value=\"Option-1\" selected>Option 1</option><option value=\"Option-2\">Option 2</option><option value=\"Option-3\">Option 3</option></select></div></div>";
        private const string DefaultData40Percent = "<div style=\"width:40% !important;display:block;\"><div class=\"form-group\"><label for=\"test\">Select an option:</label><select name=\"test\" id=\"test\"><option value=\"Select-this-option\" selected>Select this option</option><option value=\"Or-select-this-one\">Or select this one</option></select></div></div>";
        private const string DefaultData40PercentNoLabel = "<div style=\"width:40% !important;display:block;\"><div class=\"form-group\"><select name=\"test\" id=\"test\"><option value=\"Select-this-option\" selected>Select this option</option><option value=\"Or-select-this-one\">Or select this one</option></select></div></div>";
