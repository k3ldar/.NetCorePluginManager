...
namespace AspNetCore.PluginManager.Tests.Plugins.DynamicContentTests
{
    ...
    public class FormTextBoxTemplateTests : GenericBaseClass
    {
        ...
        private const string BlankDataDefaultValues12Columns = "<div class=\"col-sm-12\"><div class=\"form-group\"><label for=\"test\">Enter test data</label><input type=\"text\" class=\"form-control\" id=\"test\"></div></div>";
        private const string BlankDataDefaultValues12ColumnsNoLabel = "<div class=\"col-sm-12\"><div class=\"form-group\"><input type=\"text\" class=\"form-control\" id=\"test\"></div></div>";
        private const string BlankDataDefaultValues12ColumnsEditor = "<div class=\"col-sm-12\"><div class=\"form-group\"><label for=\"test\">Enter test data</label><input type=\"text\" class=\"form-control\" id=\"test\" disabled></div></div>";
        private const string BlankDataDefaultValues12ColumnsEditorNoLabel = "<div class=\"col-sm-12\"><div class=\"form-group\"><input type=\"text\" class=\"form-control\" id=\"test\" disabled></div></div>";
        private const string BlankDataDefaultValues10Columns = "<div class=\"col-sm-10\"><div class=\"form-group\"><label for=\"test\">Enter test data</label><input type=\"text\" class=\"form-control\" id=\"test\"></div></div>";
        private const string BlankDataDefaultValues10ColumnsNoLabel = "<div class=\"col-sm-10\"><div class=\"form-group\"><input type=\"text\" class=\"form-control\" id=\"test\"></div></div>";
        private const string BlankDataDefaultValues8Columns = "<div class=\"col-sm-8\"><div class=\"form-group\"><label for=\"test\">Enter test data</label><input type=\"text\" class=\"form-control\" id=\"test\"></div></div>";
        private const string BlankDataDefaultValues8ColumnsNoLabel = "<div class=\"col-sm-8\"><div class=\"form-group\"><input type=\"text\" class=\"form-control\" id=\"test\"></div></div>";
        private const string FormWithLabelGreenBorderLineBreak = "<div class=\"col-sm-10\"><div class=\"form-group css-class\" style=\"border: 1px solid green;\"><label for=\"textbox1\">Fill in the data</label><br /><input type=\"text\" class=\"form-control\" id=\"textbox1\"></div></div>";
        private const string FormWithLabelGreenBorder = "<div class=\"col-sm-10\"><div class=\"form-group css-class\" style=\"border: 1px solid green;\"><label for=\"textbox1\">Fill in the data</label><input type=\"text\" class=\"form-control\" id=\"textbox1\"></div></div>";
        private const string FormWithLabelGreenBorderControlStyles = "<div class=\"col-sm-10\"><div class=\"form-group css-class\" style=\"border: 1px solid green;\"><label for=\"textbox1\" style=\"border: 1px solid green;\">Fill in the data</label><input type=\"text\" class=\"form-control\" id=\"textbox1\" style=\"width: 70%;\"></div></div>";
        private const string DefaultData538Pixels = "<div style=\"width:538px !important;display:block;\"><div class=\"form-group\"><label for=\"test\">Enter test data</label><input type=\"text\" class=\"form-control\" id=\"test\"></div></div>";
        private const string DefaultData538PixelsNoLabel = "<div style=\"width:538px !important;display:block;\"><div class=\"form-group\"><input type=\"text\" class=\"form-control\" id=\"test\"></div></div>";
        private const string DefaultData40Percent = "<div style=\"width:40% !important;display:block;\"><div class=\"form-group\"><label for=\"test\">Enter test data</label><input type=\"text\" class=\"form-control\" id=\"test\"></div></div>";
        private const string DefaultData40PercentNoLabel = "<div style=\"width:40% !important;display:block;\"><div class=\"form-group\"><input type=\"text\" class=\"form-control\" id=\"test\"></div></div>";
