 ...
 *  
 *  File: MediumHeaderTemplateTests.cs
 *
 *  Purpose:  Tests for h3 template
 *
 *  Date        Name                Reason
...
namespace AspNetCore.PluginManager.Tests.Plugins.DynamicContentTests
{
    ...
    public class MediumHeaderTemplateTests
    {
        ...
        public void AssemblyNameValid_Success()
        {
            ...
            Assert.IsTrue(sut.AssemblyQualifiedName.StartsWith("DynamicContent.Plugin.Templates.MediumHeaderTemplate, DynamicContent.Plugin, Version="));
        }
        ...
        public void Name_ReturnsValidValidName_Success()
        {
            ...
            Assert.AreEqual("Medium Header", sut.Name);
        }
        ...
        public void Data_SetValue_Success()
        {
            ...
            Assert.AreEqual("<div class=\"col-sm-10\"><h3>new data</h3></div>", content);
        }
        ...
        public void Content_WidthTypeColumn_Valid()
        {
            ...
            Assert.AreEqual("<div class=\"col-sm-8\"><h3>test</h3></div>", content);
        }
        ...
        public void EditorContent_WidthTypeColumn_Valid()
        {
            ...
            Assert.AreEqual("<div class=\"col-sm-12\"><h3>test</h3></div>", content);
        }
        ...
        public void Content_WidthTypePercentage_Valid()
        {
            ...
            Assert.AreEqual("<div style=\"width:40% !important;display:block;\"><h3>test</h3></div>", content);
        }
        ...
        public void Content_WidthTypePixels_Valid()
        {
            ...
            Assert.AreEqual("<div style=\"width:538px !important;display:block;\"><h3>test</h3></div>", content);
        }
        ...
        public void Clone_EmptyUniqueId_ContainsGuid_Success()
        {
            ...
            Assert.IsInstanceOfType(clone, typeof(MediumHeaderTemplate));
