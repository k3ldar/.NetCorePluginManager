...
namespace AspNetCore.PluginManager.Tests.Plugins.DynamicContentTests
{
    ...
    public class ParagraphTemplateTests : GenericBaseClass
    {
        ...
        public void Construct_Success()
        {
            ...
            Assert.AreEqual(100, sut.TemplateSortOrder);
        }
        ...
        public void Content_WithCssClassAndStyle_Success()
        {
            ...
            Assert.AreEqual("<div class=\"col-sm-10\"><p class=\"myclass\" style=\"border: 1px solid yellow;\">new data</p></div>", content);
        }
    }
}
