...
namespace AspNetCore.PluginManager.Tests.Plugins.ImageManagerTests
{
    ...
    public class ImageViewModelTests : GenericBaseClass
    {
        ...
        {
            ImageViewModel sut = new ImageViewModel();
        ...
        {
            ImageViewModel sut = new ImageViewModel(null, false, String.Empty, String.Empty, null, new Dictionary<string, List<string>>(), new List<ImageFile>());
        }
        ...
        {
            ImageViewModel sut = new ImageViewModel(GenerateTestBaseModelData(), false, null, String.Empty, null, new Dictionary<string, List<string>>(), new List<ImageFile>());
        }
        ...
        {
            ImageViewModel sut = new ImageViewModel(GenerateTestBaseModelData(), false, "group", null, null, new Dictionary<string, List<string>>(), new List<ImageFile>());
        }
        ...
        {
            ImageViewModel sut = new ImageViewModel(GenerateTestBaseModelData(), false, String.Empty, String.Empty, null, null, new List<ImageFile>());
        }
        ...
        {
            ImageViewModel sut = new ImageViewModel(GenerateTestBaseModelData(), false, String.Empty, String.Empty, null, new Dictionary<string, List<string>>(), null);
        }
        ...
        {
            ImageViewModel sut = new ImageViewModel(GenerateTestBaseModelData(), false, "", String.Empty, null, new Dictionary<string, List<string>>(), new List<ImageFile>());
            Assert.IsNotNull(sut);
        ...
        public void Construct_ValidInstance_WithoutImage_Success()
        {
            ...
            ImageViewModel sut = new ImageViewModel(GenerateTestBaseModelData(), false, "My group", "Subgroup 1", null, groups, imageFiles);
        ...
        public void Construct_ValidInstance_WithImageAndImageManagement_Success()
        {
            ...
            ImageViewModel sut = new ImageViewModel(GenerateTestBaseModelData(), true, "My group", "Subgroup 1", imageFiles[0], groups, imageFiles);
        ...
        public void Construct_ValidInstance_WithImageAndWithoutImageManagement_Success()
        {
            ...
            ImageViewModel sut = new ImageViewModel(GenerateTestBaseModelData(), false, "My group", "Subgroup 1", imageFiles[0], groups, imageFiles);
