...
namespace AspNetCore.PluginManager.Tests.Plugins.ImageManagerTests
{
    ...
    public class UploadImageModelTests : GenericBaseClass
    {
        ...
        {
            UploadImageModel sut = new UploadImageModel();
        ...
        {
            UploadImageModel sut = new UploadImageModel(null);
        }
        ...
        {
            UploadImageModel sut = new UploadImageModel(GenerateTestBaseModelData(), null, null);
        }
        ...
        {
            UploadImageModel sut = new UploadImageModel(GenerateTestBaseModelData(), "", null);
        }
        ...
        {
            UploadImageModel sut = new UploadImageModel(GenerateTestBaseModelData());
        ...
        {
            UploadImageModel sut = new UploadImageModel(GenerateTestBaseModelData(), "My Group", "My Subgroup");
