 ...
 *  
 *  File: LoginCheckSubMenuTests.cs
 *
 *  Purpose:  Tests for LoginCheckSubMenu
 *
 *  Date        Name                Reason
...
namespace AspNetCore.PluginManager.Tests.Plugins.LoginTests
{
    ...
    public class LoginCheckSubMenuTests
    {
        ...
        public void CreateValidInstance_Success()
        {
            ...
            LoginCheckSubMenu sut = new LoginCheckSubMenu();
            ...
            Assert.AreEqual("Login Validation", sut.Name());
